...
public class UserAdminCreateShipmentPage {
	...
	@FindBy(xpath = "//div[@class='card-body pb-3']//div[2]//div//div//div[text()='pkt']")
	...
	@FindBy(id = "WarenversenderClass")
	WebElement warenVerSenderLinkAddress;
	@FindBy(id="txtFAnsprechpartner")
	WebElement warenVersenderAnsprechpartnerField;
	@FindBy(id="txtFFirma")
	WebElement warenVersenderFirmaField;
	@FindBy(id="txtFFirmenname2")
	WebElement warenVersenderFirma2Field;
	@FindBy(id="txtFStreet")
	WebElement warenVersenderStreetField;
	@FindBy(id="txtFHouseno")
	WebElement warenVersenderHousenoField;
	@FindBy(xpath="//div[@id='dvLand']//div//div//div[2]")
	WebElement warenVersenderLandArrowButton;
	@FindBy(id="txtFStadtPlz")
	WebElement stadtOderPLZ;
	@FindBy(id="txtFAreacode")
	WebElement warenVersenderAreaCode;
	@FindBy(id="txtFTelefon")
	WebElement warenVersenderTeleFonNum;
	@FindBy(id="txtFMobile")
	WebElement warenVersenderMobile;
	@FindBy(id="txtFEmail")
	WebElement warenVersenderEmail;
	
	public void sendWarenVersenderEmail(String email) {
		warenVersenderEmail.clear();
		warenVersenderEmail.sendKeys(email);
	}
	public void sendWarenVerMobileNumber(String mobileNumber) {
		warenVersenderMobile.clear();
		warenVersenderMobile.sendKeys(mobileNumber);
	}
	public void sendTlephoneNumber(String fonNum) {
		warenVersenderTeleFonNum.clear();
		warenVersenderTeleFonNum.sendKeys(fonNum);
	}
	public void sendAreaCode(String areaCode) {
		warenVersenderAreaCode.clear();
		warenVersenderAreaCode.sendKeys(areaCode);
	}
	public void sendOnstadtOderPLZField(String stadtOderPin) {
		stadtOderPLZ.clear();
		stadtOderPLZ.sendKeys(stadtOderPin);
	}
	public void selectWarenVersenderLand(String land) {
		String elementPath = "//div[@id='dvLand']//div//div//div//ul//li[text()='"+land+"']";
		WebElement landElement = driver.findElement(By.xpath(elementPath));
		landElement.click();
	}
	public void clickOnWarenVersenderLandArrowButton() {		
		warenVersenderLandArrowButton.click();
	}
	public void sendOnWarenVersenderHousenoField(String houseNo) {
		warenVersenderHousenoField.clear();
		warenVersenderHousenoField.sendKeys(houseNo);
	}
	public void sendOnWarenVersenderStreetField(String street) {
		warenVersenderStreetField.clear();
		warenVersenderStreetField.sendKeys(street);
	}
	public void sendOnWarenVersenderFirma2Field(String firma2) {
		warenVersenderFirma2Field.clear();
		warenVersenderFirma2Field.sendKeys(firma2);
	}
	public void sendOnwarenVersenderFirmaField(String firma) {
		warenVersenderFirmaField.clear();
		warenVersenderFirmaField.sendKeys(firma);
	}
	public void sendOnwarenVersenderAnsprechpartnerField(String ansprechpartner) {
		warenVersenderAnsprechpartnerField.clear();
		warenVersenderAnsprechpartnerField.sendKeys(ansprechpartner);
	}
	public String getCurrentUrl() {
		return gu.getCurrentUrlOfPage(driver);
	}
	public void clickOnWarenVerSenderLinkAddress() {
		warenVerSenderLinkAddress.click();
	}
	...
	public void scrollDownAbholungVonField() {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,500)");
	}

	public void scrollUpAbholungVonField() {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,-500)");
	}
